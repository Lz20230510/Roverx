...
u8 USART2_SD_BUF[USART2_REC_LEN];			//发送缓冲区 ，最大USART_REC_LEN_S个字节.
//接收状态
//bit15，	接收完成标志
//bit14，	接收到0x0d
//bit13~0，	接收到的有效字节数目
...
void usart2_init(u32 bound,u8 PreemptionPriority,u8 SubPriority )						//u8 PreemptionPriority:抢占优先级，u8 SubPriority子优先级
{
  //GPIO端口设置
