...
//	LCD_DisplayNum(90,20,res,3,16,0);//显示MPU6500的ID
...
//	LCD_DisplayNum(90,40,res,3,16,0);//显示AK89630的ID
...
Smc345.scm345Angle =bcd_to_hex((unsigned char*) magnetometer[3]);  //磁力计数据赋值    强制转换  
